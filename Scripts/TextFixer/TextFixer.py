        ...
        for i in nuke.allNodes('Group'):
            ...
            for node in nuke.allNodes('Text2'):
                try:
                    ...
                    pass
            i.end()
        if nuke.ask("<b><center><font color=orange>These are the new Text ( Class=Text2 ) nodes in your script:\n\n<font color=yellow>" + ', '.join(newText) + "\n\n<font color=orange>Would you like to zoom on them?"):
            nuke.zoomToFitSelected()
    else:
